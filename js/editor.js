...
ZenPen.editor = (function() {
	...
	function bindElements() {
		...
		decField = document.querySelector( '.dec' );
	...
	function saveState( event ) {
		...
		localStorage[ 'dec' ] = decField.innerHTML;
		localStorage[ 'author' ] = authorField.innerHTML;
	...
	function loadState() {
		...
		if ( localStorage[ 'author' ] ) {
			console.log('author')
			authorField.innerHTML = localStorage[ 'author' ];
		} else {
			loadDefaultAuthor()
		}		

		if ( localStorage[ 'dec' ] ) {
			decField.innerHTML = localStorage[ 'dec' ];
		} else {
			loadDefaultDes()
		}		
	}
	...
	function loadDefaultAuthor() {
		// console.log(authorField.innerHTML)
		authorField.innerHTML = defaultAuthor; // in default.js
	}	

	function loadDefaultDes() {
		// console.log(decField.innerHTML)
		decField.innerHTML = defaultDes; // in default.js
	}	
	...
	//获得指定区域里的文字数
	//ct
	function getWordCount2(Field) {
		var text = ZenPen.util.getText( Field );
